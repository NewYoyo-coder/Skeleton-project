...
async function run() {
  ...
  // 감소 폭을 줄여(-8 -> -4) 더 세밀하게 스캔하고, 범위를 넓힘
  ...
  console.log(
    `  URL: ${RESET}🌸 \x1b[4mhttp://localhost:5173/\x1b[0m 🌸  ${KB_MAIN}[a]키를 눌러서 브라우저로 바로 이동할 수 있어요${RESET}\n`,
  );
